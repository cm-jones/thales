...
IBOrder::IBOrder(const std::string &action, double total_quantity,
...
IBOrderState::IBOrderState(const std::string &status) : status(status) {}
...
IBExecution::IBExecution(const std::string &exec_id,
                         const std::string &order_id, double shares,
                         double price)
