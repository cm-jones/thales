#ifndef THALES_CORE_RISK_MANAGER_H
#define THALES_CORE_RISK_MANAGER_H
...
public:
     ...
     */
    double getMaxPositionSize(const std::string& symbol, const Portfolio& portfolio) const;
...
private:
    ...
    // Private methods
    double calculatePositionRisk(const std::string& symbol, double quantity, const Portfolio& portfolio) const;
...
#endif // THALES_CORE_RISK_MANAGER_H
