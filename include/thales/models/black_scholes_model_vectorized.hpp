...
class BlackScholesVectorized {
   public:
    ...
    static void vectorized_call_price(const double *S_array,
    ...
    /// @param n Number of options to price
    static void vectorized_put_price(const double *S_array,
                                     const double *K_array,
                                     const double *r_array,
                                     const double *sigma_array,
                                     const double *T_array,
    ...
    static void vectorized_call_delta(const double *S_array,
                                      const double *K_array,
                                      const double *r_array,
                                      const double *sigma_array,
                                      const double *T_array,
