...
class BlackScholesModel {
    public:
         ...
         */
        static double gamma(double S, double K, double r, double sigma,
                            double T);
         ...
         */
        static double vega(double S, double K, double r, double sigma,
                           double T);
         ...
         */
        static double put_rho(double S, double K, double r, double sigma,
                              double T);
