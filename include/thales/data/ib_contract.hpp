...
/**
 * @class IBContract
 * @brief Represents a financial instrument contract in the Interactive Brokers API.
 * 
...
public:
    ...
    std::shared_ptr<IBContract> delta_neutral_contract;  // Delta neutral contract (using shared_ptr for copyability)
 ...
 * @brief Represents detailed information about a contract in the Interactive Brokers API.
 * 
 * This class is a simplified version of the IB::ContractDetails class from the IB API.
 * It contains the contract itself plus additional details about the contract.
 */
class IBContractDetails {
public:
    /**
 ...
 * 
 * This class is a simplified version of the IB::ContractDescription class from the IB API.
 * It contains a contract and a list of derivative security types.
 */
class IBContractDescription {
public:
    /**
