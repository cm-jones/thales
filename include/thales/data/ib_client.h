#ifndef THALES_DATA_IB_CLIENT_H
#define THALES_DATA_IB_CLIENT_H
...
public:
     ...
     * @param interval The interval for the historical data (e.g., "1min", "1hour", "1day")
     ...
     */
    std::vector<core::Position> getPositions() const;
     ...
     * @param callback The callback function to set
     */
    void setOrderUpdateCallback(std::function<void(const core::Order&)> callback);
    
    /**
     * @brief Set a callback for position updates
     * @param callback The callback function to set
     */
    void setPositionUpdateCallback(std::function<void(const core::Position&)> callback);
