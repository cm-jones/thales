...
public:
     ...
     */
    IBOrder(const std::string& action, double total_quantity, const std::string& order_type);
    ...
    bool override_percentage_constraints = false;  // Override percentage constraints flag
    ...
    std::string delta_neutral_clearing_account;  // Delta neutral clearing account
    ...
    std::string delta_neutral_designated_location;  // Delta neutral designated location
 ...
 * 
 * This class is a simplified version of the IB::OrderState class from the IB API.
 * It contains information about the current state of an order.
 */
class IBOrderState {
public:
    /**
 ...
 * 
 * This class is a simplified version of the IB::Execution class from the IB API.
 * It contains information about an order execution.
 */
class IBExecution {
public:
    /**
     ...
     */
    IBExecution(const std::string& exec_id, const std::string& order_id, double shares, double price);
