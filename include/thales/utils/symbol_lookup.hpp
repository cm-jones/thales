...
/// IDs.
///
/// @note This class implements the singleton pattern to ensure there is only
/// one instance of the lookup table throughout the application. It allows
...
class SymbolLookup {
  public:
     ...
     */
    SymbolID get_id(const std::string &symbol) const;
     ...
     */
    std::string get_symbol(SymbolID id) const;
